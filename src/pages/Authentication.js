...
export async function action ({request ,}) {
  ...
  //---------------------------------------------
  const response = await fetch('https://events-manager-api-e67f.onrender.com/'+mode , {method : 'POST' , headers : {'Content-Type' : 'application/json'} , body : JSON.stringify(authData)}) ;
  //------------------------------------------------
